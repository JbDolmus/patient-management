            ...
            >
                ...
                <div className="flex flex-col justify-between gap-2 md:flex-row">
                    ...
                    {activeId &&
                        <input 
                        type="button"
                            className="bg-gray-600 w-full p-3 text-white uppercase font-bold hover:bg-gray-700 cursor-pointer transition-colors rounded-md"
                            value='Cancelar'
                            onClick={cancelRegisterPatient}
                        />
                    }
                </div>
